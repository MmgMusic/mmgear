document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateMediaSession(item) {
        ...
        // MODIFICATION : Ajout des gestionnaires d'état pour une meilleure intégration mobile
    ...
    function initializeApp() {
        ...
        handleMenuNavigation(sectionToLoad, false);

        if (!window.location.hash || window.location.hash === "#") {
            programmaticHashChange = true;
            window.location.hash = 'menu-cards-section';
        }
    }
    ...
    function setupEventListeners() {
        ...
        const musicTitlesTutorialSteps = [
            ...
            },
            {
                ...
                reverseAction: () => {
                    document.getElementById('temp-play-btn').classList.add('hidden');
                }
            },
            {
                step: 8,
        ...
        function startTutorial(guideKey) {
            ...
            if (guideKey === 'music') {
                ...
                isAutoplayActive = false; // Désactive temporairement l'autoplay pour la cohérence du guide
            }
