        ...
        Object.entries(cardsData).forEach(([key, item]) => {
            ...
            if (cardType === 'menu' && activeProfile === 'mmg-music') {
                ...
                if (iconInfo) {
                    ...
                    cardTextHtml = `<p class="card__title">${item.title}</p>`; // CORRECTION: Utilisation de card__title pour la cohérence
                } else { // "À propos"
                ...
                if (cardType === 'menu' && activeProfile === 'mmg-beats') {
                    ...
                    switch(cardType) {
                        case 'title': description = item.description || getTranslation('listenToTitle'); break;
