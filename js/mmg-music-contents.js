    ...
    function setupEventListeners() {
        ...
        if ('documentPictureInPicture' in window) {
            ...
            pipButton.addEventListener('click', async () => {
                try {
                    if (pipWindow) {
                        // Element is already in PiP, no standard way to close programmatically,
                        // user must close the window. We just log it.
                        console.log("PiP window is already open. Please close it manually.");
                    } else {
                        ...
                        // Listen for the PiP window to close
                        pipWindow.addEventListener('pagehide', () => {
                            const originalContainer = document.querySelector('.bottom-ui-container');
                            originalContainer.insertBefore(playerContainer, originalContainer.firstChild);
                            pipWindow = null;
                        });
                    }
                } catch (error) {
