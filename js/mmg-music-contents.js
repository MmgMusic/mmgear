...
function setupEventListeners() {
    ...
    const mobileMainMenuTutorialSteps = [
        ...
        { step: 7, selector: '#daily-bonus-section', textKey: 'guide1_mobile_step_7', position: 'pos-top' },
        { step: 8, selector: () => document.querySelector('.dashboard-row-split > div:nth-child(1)'), textKey: 'guide1_mobile_step_8', position: 'pos-top' },
        { step: 9, selector: () => document.querySelector('.dashboard-row-split > div:nth-child(2)'), textKey: 'guide1_mobile_step_9', position: 'pos-top' },
        { step: 10, selector: () => document.querySelector('.dashboard-row-split > div:nth-child(3)'), textKey: 'guide1_mobile_step_10', position: 'pos-top' },
        { step: 11, selector: '.dashboard-guide-section', textKey: 'guide1_mobile_step_11', position: 'pos-top' },
        { step: 12, selector: '.dashboard-about-section', textKey: 'guide1_mobile_step_12', position: 'pos-top' }
    ];
