document.addEventListener('DOMContentLoaded', () => {
    ...
    if (welcomeBgMusicSwitch && bgMusicAudio) {
        // CORRECTION: On ne fait plus rien lors du changement. Le switch sert uniquement à
        // déterminer si la musique doit se lancer APRÈS avoir cliqué sur "ENTRER".
        // La logique de lecture/pause est maintenant gérée uniquement au moment du clic sur "ENTRER".
    }
